...
export default function DumiContextWrapper() {
  ...
  return (
    <SiteContext.Provider value={{
      ...
      setLoading,
      hostname: undefined,
      themeConfig: {"logo":"https://simlove-sdk.oss-cn-shenzhen.aliyuncs.com/sl-web-sdk/img/logo.png","title":"lx-document","footer":"simplove-简爱官方文档","prefersColor":{"default":"light","switch":true},"nprogress":true,"lastUpdated":true,"socialLinks":{"github":"https://liuxiangproject.coding.net/p/liuxaing/d/lx-document/git"},"rtl":true},
